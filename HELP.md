...
* The original package name 'com.team.secure-todo' is invalid and this project uses 'com.team.secure_todo' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/3.3.12/reference/web/spring-security.html#web.security.oauth2.client)
* [OAuth2 Authorization Server](https://docs.spring.io/spring-boot/3.3.12/reference/web/spring-security.html#web.security.oauth2.authorization-server)
